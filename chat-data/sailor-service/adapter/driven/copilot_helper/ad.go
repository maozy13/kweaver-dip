...
type AD interface {
	...
	//SearchEngine 自定义认知服务
	PromptEngine(ctx context.Context, content any) (*PromptResponse, error)
	//SearchEngine 自定义认知服务
	CpRecommendCodeEngine(ctx context.Context, content any) (*CpRecommendCodeResponse, error)
	//SearchEngine 自定义认知服务
	CpRecommendTableEngine(ctx context.Context, content any) (*CpRecommendTableResponse, error)
	//SearchEngine 自定义认知服务
	CpRecommendFlowEngine(ctx context.Context, content any) (*CpRecommendFlowResponse, error)
	//SearchEngine 自定义认知服务
	CpRecommendCheckCodeEngine(ctx context.Context, content any) (*CpRecommendCheckCodeResponse, error)

	// 主题模型推荐
	RecommendSubjectModelEngine(ctx context.Context, content any) (*RecommendSubjectModelResponse, error)

	CpRecommendViewEngine(ctx context.Context, content any) (*CpRecommendViewResponse, error)
	CpRecommendAssetSearchEngine(ctx context.Context, content any) (*CpRecommendAssetSearchResponse, error)

	CpRecommendAssetSearchEngineV2(ctx context.Context, vType string, content any, searchType string) (*CpRecommendAssetSearchResponse, error)
	CpRecommendAssetSearchEngineV3(ctx context.Context, content any) (*CpRecommendAssetSearchResponse, error)
	//SailorCognitiveDataCatalogSearchNew(ctx context.Context, content any) (*CpRecommendAssetSearchResponse, error)
	SailorCognitiveResourceAnalysisSearchEngine(ctx context.Context, content any) (*SailorCognitiveResourceAnalysisSearchResponse, error)
	SailorCognitiveDataCatalogAnalysisSearchEngine(ctx context.Context, content any) (*SailorCognitiveDataCatalogAnalysisSearchResponse, error)
	//GraphAnalysis 图分析服务
	...
	CpTestLLMEngine(ctx context.Context, req map[string]any) (*CpTestLLMResp, error)
	CpText2SqlEngine(ctx context.Context, content any, authorization string) (*CpText2SqlResp, error)
	SailorLogicalViewDataCategorizeEngine(ctx context.Context, content any) (*SailorLogicalViewDataCategorizeResp, error)
	...
	SailorFormViewGenerateFakeSamples(ctx context.Context, req map[string]any) (*SamplesItemList, error)
	SailorTableCompletionTableInfoEngine(ctx context.Context, req map[string]any) (*SailorTableCompletionTableInfoResp, error)
	SailorTableCompletionEngine(ctx context.Context, req map[string]any) (*SailorTableCompletionResp, error)
}
...
func NewAD(httpClient *http.Client) AD {
	...
	return &ad{
		baseUrl:     cfg.URL,
		baseCUrl:    settings.GetConfig().AfSailorConf.URL,
...
func httpPostDoP[T any](ctx context.Context, url string, bodyReq any, headers map[string][]string, a *ad) (*T, error) {
...
func httpJsonDoP[T any](ctx context.Context, httpMethod, url string, bodyReq any, headers map[string][]string, a *ad) (*T, error) {
	var err error
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
	...
	return httpADDoP[T](ctx, httpMethod, url, body, headers, true, a)
}
...
func httpADDoP[T any](ctx context.Context, httpMethod, url string, bodyParam any, headers url.Values, needAppKey bool, a *ad) (*T, error) {
	var err error
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
...
func httpDo[T any](ctx context.Context, httpMethod, url string, body io.Reader, bodyStr string, headers url.Values, a *ad) (*T, error) {
	...
	if err != nil {
		...
		return nil, errorcode.Detail(errorcode.AFSailorConnectionError, err)
	}
	defer func() {
		_ = resp.Body.Close()
	}()
...
func httpSSE(ctx context.Context, httpMethod, url string, a *ad) {
	var err error
	ctx, span := trace.StartInternalSpan(ctx)
	defer func() { trace.TelemetrySpanEnd(span, err) }()
...
// 	return httpGetDo[ListGraphBuildTaskResp](ctx, u, a)
// }
